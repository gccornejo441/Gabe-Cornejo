      ...
      <Layout>
        <div className="text-center flex justify-center mt-12 md:mt-36">
          <div className="px-10 md:px-10 md:w-1/2">
            ...
            <h1 className="text-2xl text-mac-purple font-bold pb-10">Hi, I&aposm Gabe.</h1>
            <p className="text-lg text-mac-purple font-bold mb-12">
              I&aposm a web developer based in California.  I&aposm currently working away at developing awesome web apps.  In my free time I like to spend time with my family and work on side projects.
            </p>
          </div>
        </div>
      </Layout>
